    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.post-categories.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="cat_name">{{ trans('cruds.postCategory.fields.cat_name') }}</label>
                            <input class="form-control" type="text" name="cat_name" id="cat_name" value="{{ old('cat_name', '') }}" required>
