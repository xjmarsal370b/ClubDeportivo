                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.events.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="event_name" id="event_name" value="{{ old('event_name', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="date_event" id="date_event" value="{{ old('date_event') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="desc_event" id="desc_event" value="{{ old('desc_event', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="transportation_id" id="transportation_id" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="organizer_id" id="organizer_id" required>
                                @foreach($organizers as $id => $entry)
                                    <option value="{{ $id }}" {{ old('organizer_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="members[]" id="members" multiple required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="event_img-dropzone">
                            </div>
