                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.posts.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="post_title" id="post_title" value="{{ old('post_title', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="post_header" id="post_header" value="{{ old('post_header', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Post::POST_STATUS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="post_status_{{ $key }}" name="post_status" value="{{ $key }}" {{ old('post_status', 'draft_status') === (string) $key ? 'checked' : '' }} required>
