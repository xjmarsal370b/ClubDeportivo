                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.posts.update", [$post->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="post_title" id="post_title" value="{{ old('post_title', $post->post_title) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="post_header" id="post_header" value="{{ old('post_header', $post->post_header) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Post::POST_STATUS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="post_status_{{ $key }}" name="post_status" value="{{ $key }}" {{ old('post_status', $post->post_status) === (string) $key ? 'checked' : '' }} required>
                                    <label for="post_status_{{ $key }}">{{ $label }}</label>
                                </div>
                            @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="post_img-dropzone">
                            </div>
