    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.events.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('date_event') ? 'is-invalid' : '' }}" type="text" name="date_event" id="date_event" value="{{ old('date_event') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('desc_event') ? 'is-invalid' : '' }}" type="text" name="desc_event" id="desc_event" value="{{ old('desc_event', '') }}" required>
