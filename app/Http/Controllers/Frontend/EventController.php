...
class EventController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.events.create', compact('members', 'organizers', 'transportations'));
    }
    ...
    public function edit(Event $event)
    {
        ...
        return view('frontend.events.edit', compact('event', 'members', 'organizers', 'transportations'));
    }
